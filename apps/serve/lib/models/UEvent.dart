...
class UEvent extends amplify_core.Model {
  ...
  UEvent.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _owner = json['owner'] != null
        ? json['owner']['serializedData'] != null
          ? UUser.fromJson(new Map<String, dynamic>.from(json['owner']['serializedData']))
          : UUser.fromJson(new Map<String, dynamic>.from(json['owner']))
        : null,
      _leader = json['leader'] != null
        ? json['leader']['serializedData'] != null
          ? UUser.fromJson(new Map<String, dynamic>.from(json['leader']['serializedData']))
          : UUser.fromJson(new Map<String, dynamic>.from(json['leader']))
        : null,
