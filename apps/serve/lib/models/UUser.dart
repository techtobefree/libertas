...
class UUser extends amplify_core.Model {
  ...
  final List<ULeaderRequest>? _leaderRequestsSent;
  final List<ULeaderRequest>? _leaderRequestsReceived;
  ...
  UUserModelIdentifier get modelIdentifier {
    return UUserModelIdentifier(id: id);
  }
  ...
  List<ULeaderRequest>? get leaderRequestsSent {
    return _leaderRequestsSent;
  }

  List<ULeaderRequest>? get leaderRequestsReceived {
    return _leaderRequestsReceived;
  }
  ...
  const UUser._internal(
      ...
      : _password = password,
        ...
        _posts = posts,
        _sponsors = sponsors,
        _leaderRequestsSent = leaderRequestsSent,
        _leaderRequestsReceived = leaderRequestsReceived,
        _createdAt = createdAt,
        _updatedAt = updatedAt,
        _uUserFriendsId = uUserFriendsId;
  ...
  factory UUser(
      ...
      List<ULeaderRequest>? leaderRequestsSent,
      List<ULeaderRequest>? leaderRequestsReceived,
    ...
    return UUser._internal(
        ...
        projects:
            projects != null ? List<UProject>.unmodifiable(projects) : projects,
        friends: friends != null ? List<UUser>.unmodifiable(friends) : friends,
        posts: posts != null ? List<UPost>.unmodifiable(posts) : posts,
        sponsors:
            sponsors != null ? List<USponsor>.unmodifiable(sponsors) : sponsors,
        leaderRequestsSent: leaderRequestsSent != null
            ? List<ULeaderRequest>.unmodifiable(leaderRequestsSent)
            : leaderRequestsSent,
        leaderRequestsReceived: leaderRequestsReceived != null
            ? List<ULeaderRequest>.unmodifiable(leaderRequestsReceived)
            : leaderRequestsReceived,
  ...
  bool operator ==(Object other) {
    ...
    return other is UUser &&
        ...
        DeepCollectionEquality()
            .equals(_leaderRequestsSent, other._leaderRequestsSent) &&
        DeepCollectionEquality()
            .equals(_leaderRequestsReceived, other._leaderRequestsReceived) &&
  ...
  UUser copyWith(
    ...
    return UUser._internal(
        ...
        leaderRequestsSent: leaderRequestsSent ?? this.leaderRequestsSent,
        leaderRequestsReceived:
            leaderRequestsReceived ?? this.leaderRequestsReceived,
  ...
  UUser copyWithModelFieldValues(
      ...
      ModelFieldValue<List<ULeaderRequest>?>? leaderRequestsSent,
      ModelFieldValue<List<ULeaderRequest>?>? leaderRequestsReceived,
    ...
    return UUser._internal(
        ...
        leaderRequestsSent: leaderRequestsSent == null
            ? this.leaderRequestsSent
            : leaderRequestsSent.value,
        leaderRequestsReceived: leaderRequestsReceived == null
            ? this.leaderRequestsReceived
            : leaderRequestsReceived.value,
        uUserFriendsId: uUserFriendsId == null
            ? this.uUserFriendsId
            : uUserFriendsId.value);
  }
      ...
      : id = json['id'],
        ...
        _sponsors = json['sponsors'] is List
            ? (json['sponsors'] as List)
                .where((e) => e?['serializedData'] != null)
                .map((e) => USponsor.fromJson(
                    new Map<String, dynamic>.from(e['serializedData'])))
                .toList()
            : null,
        _leaderRequestsSent = json['leaderRequestsSent'] is List
            ? (json['leaderRequestsSent'] as List)
                .where((e) => e?['serializedData'] != null)
                .map((e) => ULeaderRequest.fromJson(
                    new Map<String, dynamic>.from(e['serializedData'])))
                .toList()
            : null,
        _leaderRequestsReceived = json['leaderRequestsReceived'] is List
            ? (json['leaderRequestsReceived'] as List)
                .where((e) => e?['serializedData'] != null)
                .map((e) => ULeaderRequest.fromJson(
                    new Map<String, dynamic>.from(e['serializedData'])))
                .toList()
  ...
  Map<String, dynamic> toJson() => {
        ...
        'projects': _projects?.map((UProject? e) => e?.toJson()).toList(),
        'friends': _friends?.map((UUser? e) => e?.toJson()).toList(),
        'posts': _posts?.map((UPost? e) => e?.toJson()).toList(),
        'sponsors': _sponsors?.map((USponsor? e) => e?.toJson()).toList(),
        'leaderRequestsSent': _leaderRequestsSent
            ?.map((ULeaderRequest? e) => e?.toJson())
            .toList(),
        'leaderRequestsReceived': _leaderRequestsReceived
            ?.map((ULeaderRequest? e) => e?.toJson())
            .toList(),
  ...
  static final amplify_core.QueryModelIdentifier<UUserModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<UUserModelIdentifier>();
  ...
  static final PROFILEPICTUREURL =
      amplify_core.QueryField(fieldName: "profilePictureUrl");
  static final COVERPICTUREURL =
      amplify_core.QueryField(fieldName: "coverPictureUrl");
  ...
  static final LEADERREQUESTSSENT = amplify_core.QueryField(
      fieldName: "leaderRequestsSent",
      fieldType: amplify_core.ModelFieldType(
          amplify_core.ModelFieldTypeEnum.model,
          ofModelName: 'ULeaderRequest'));
  static final LEADERREQUESTSRECEIVED = amplify_core.QueryField(
      fieldName: "leaderRequestsReceived",
      fieldType: amplify_core.ModelFieldType(
          amplify_core.ModelFieldTypeEnum.model,
          ofModelName: 'ULeaderRequest'));
  static final UUSERFRIENDSID =
      amplify_core.QueryField(fieldName: "uUserFriendsId");
  static var schema = amplify_core.Model.defineSchema(
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.hasMany(
        key: UUser.LEADERREQUESTSSENT,
        isRequired: false,
        ofModelName: 'ULeaderRequest',
        associatedKey: ULeaderRequest.OWNER));

    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.hasMany(
        key: UUser.LEADERREQUESTSRECEIVED,
        isRequired: false,
        ofModelName: 'ULeaderRequest',
        associatedKey: ULeaderRequest.OWNER));
...
class UUserModelIdentifier implements amplify_core.ModelIdentifier<UUser> {
  ...
  const UUserModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is UUserModelIdentifier && id == other.id;
  }
