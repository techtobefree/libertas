...
class _NewUserWelcome3State extends State<NewUserWelcome3> {
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text(
                'Join today and be a part of the solution. Together, the foundational strength of your community will be strong. Find joy in being an active participant. Many hands do make light work and ensure greater fairness and well-being for all. With your help, your community will thrive to greatness. Welcome aboard your gateway to meaningful service opportunities.',
